...
export type HandlerFactory = (app: Probot, options: ApplicationFunctionOptions) => Handler | Promise<Handler>;
export type ApplicationFunction = (app: Probot, options: ApplicationFunctionOptions) => void | Promise<void>;
export type Handler = (req: IncomingMessage, res: ServerResponse) => void | boolean | Promise<void | boolean>;
